    ...
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ route('profileIndustri') }}" class="text-decoration-none">
                    <div class="card shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <i class="fas fa-user-edit fa-2x text-gray-500"></i>
                                </div>
                                <div class="col ml-2">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ route('monitoringBantuan') }}" class="text-decoration-none">
                    <div class="card shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
            ...
            <!-- List Sekolah Card -->
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ route('listSekolah') }}" class="text-decoration-none">
                    <div class="card shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <i class="fas fa-school fa-2x text-gray-500"></i>
                                </div>
                                <div class="col ml-2">
