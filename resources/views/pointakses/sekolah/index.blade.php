    ...
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ route('profileSekolah') }}" class="text-decoration-none">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ route('monitoringBantuanSekolah') }}" class="text-decoration-none">
                    <div class="card shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
            ...
            <!-- Laporan Card -->
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ route('0Persen') }}" class="text-decoration-none">
                    <div class="card shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
